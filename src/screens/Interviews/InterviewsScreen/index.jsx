...
const InterviewsScreen = () => {
    ...
    useEffect(() => {
        const unsubscribeInterviews = interviewsCollectionRef.onSnapshot(snapshot => {
            ...
            interviewsList.sort((interview1, interview2) => {
                const localDate1 = getLocalDateFromFirebaseTimestamp(interview1.createdAt);
                const localDate2 = getLocalDateFromFirebaseTimestamp(interview2.createdAt);
